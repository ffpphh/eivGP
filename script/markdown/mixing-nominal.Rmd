...
ggsave(paste0(params$fig.code, "prob-summary.pdf"), plot = grid.arrange(grobs = plot_list, nrow = 5, widths = c(1, 1, 1.2)), width = 8*3, height = 6*5)
```


```{r fig.cap = 'Classification region', fig.width = 8, fig.height = 6*2, echo = FALSE}
##
plot_list <- list()
